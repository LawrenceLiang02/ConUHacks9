...
function CardComponent({ id, title, imageUrl, likes, usedIngredients, missingIngredients, total_price, original_price }: Recipe) {
            ...
            <div 
                ...
                className="absolute w-full h-full [backface-visibility:hidden] bg-white rounded-2xl flex flex-col justify-around items-end shadow-lg ease-in-out duration-200">
                    ...
                    <div className="w-full h-auto flex flex-col items-start shadow-t-lg px-4 py-3 space-y-2">
                        ...
                        <div className="card-text card-text-shadow w-full flex flex-row justify-between">
                            <a className="flex flex-row justify-between px-1 space-x-2">
                                <p>{likes}</p>
                            ...
                            {(original_price > 0 || total_price > 0) && (
                                <div className="flex flex-row space-x-2 text-red-500">
                                    <p className="">Save: </p>
                                    <p className="">${(original_price - total_price).toFixed(2)}</p>
                                </div>
                            )}
                        </div>
                    </div>
