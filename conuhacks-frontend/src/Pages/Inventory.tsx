    ...
    const openCamera = async () => {
        try {
            ...
            if (fileInputRef.current) {
                fileInputRef.current.setAttribute("capture", "environment"); // Open back camera
        ...
        <div className="w-full min-h-screen px-[8%] pt-6">
            <div className="mb-4 flex flex-row justify-between">
                ...
                <div className="flex flex-row space-x-4">
                    <div className="px-2 hover:cursor-pointer hover:scale-[110%] ease-in-out duration-300" onClick={openCamera}>
                    ...
                    <div>
                        ...
                        <div className="hover:cursor-pointer" onClick={openFileSelector}>
